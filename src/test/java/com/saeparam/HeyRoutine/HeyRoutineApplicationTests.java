...
import com.saeparam.HeyRoutine.domain.test.Coupon;
import com.saeparam.HeyRoutine.domain.test.CouponDecreaseService;
import com.saeparam.HeyRoutine.domain.test.CouponRepository;
...
@SpringBootTest
class HeyRoutineApplicationTests {
	@Autowired
